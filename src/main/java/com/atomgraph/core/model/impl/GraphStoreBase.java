 ...
 */
public abstract class GraphStoreBase
{
     ...
     */
    @Inject
    public GraphStoreBase(@Context Request request, Service service, MediaTypes mediaTypes)
    {
     ...
     * @param mediaTypes supported media types
     */
    public GraphStoreBase(Request request, DatasetAccessor accessor, MediaTypes mediaTypes)
    {
     ...
     * @return response
     */
    public Response get(Boolean defaultGraph, URI graphUri)
    {
     ...
     * @return response
     */
    public Response post(Model model, Boolean defaultGraph, URI graphUri)
    {
        if (!(defaultGraph ^ graphUri != null)) throw new BadRequestException("Either default or named graph has to be specified");
     ...
     * @return response
     */    
    public Response put(Model model, Boolean defaultGraph, URI graphUri)
    {
        if (!(defaultGraph ^ graphUri != null)) throw new BadRequestException("Either default or named graph has to be specified");
     ...
     * @return response
     */
    public Response delete(Boolean defaultGraph, URI graphUri)
    {
        if (!(defaultGraph ^ graphUri != null)) throw new BadRequestException("Either default or named graph has to be specified");
     ...
     */
    public ResponseBuilder evaluatePreconditions(Model model, URI graphUri)
    {
    ...
    /**
     * Returns list of writable media types for the given class.
     *
     * @param clazz the class to get writable media types for
     * @return list of writable media types
     */
