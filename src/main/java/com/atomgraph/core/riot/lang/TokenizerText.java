...
public class TokenizerText implements Tokenizer // why final???
{
        ...
        if ( ch == CH_QUOTE1 || ch == CH_QUOTE2 )
        {
            ...
            if (ch2 == ch )
            {
                ...
                else
                {
                    ...
                    //if ( ch1 != EOF ) getReader().pushbackChar(ch1) ;    // Must be '' or ""
                    token.setImage("") ;
        ...
        */
        ...
        if ( ch == '0' )
        {
            ...
            if ( ch == 'x' || ch == 'X' )
            {
                getReader().readChar() ;
                stringBuilder.append((char)ch) ;
                readHex(getReader(), stringBuilder) ;
                token.setImage(stringBuilder.toString()) ;
