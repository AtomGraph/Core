...
public class SimpleGraphStoreClient
{
    ...
    protected SimpleGraphStoreClient(WebResource webResource)
    {
    ...
    public static SimpleGraphStoreClient create(WebResource webResource)
    {
        return new SimpleGraphStoreClient(webResource);
    }
